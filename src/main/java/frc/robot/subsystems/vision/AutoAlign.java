...
public class AutoAlign {
    ...
    private PIDController yPoseController = new PIDController(1.0, 0, 0);
    private PIDController xPoseController = new PIDController(1.0, 0, 0);
    private PIDController rotController = new PIDController(1.0, 0, 0);
